...
plt.figure(figsize=(8,6))
sns.regplot(data=df_teams,x="squad_size",y="total_market",color="blue",line_kws={"color":"red"})
plt.title("Squad size vs. total market value (with regression line)")
plt.xlabel("Squad size")
plt.ylabel("Total market value")
plt.grid(True)
teams_fig_file_path=os.path.join(save_figure_teams_dir,"Squad size vs. total market value (with regression line).jpg")
plt.savefig(teams_fig_file_path,format="jpg")
plt.close()
print(f"Figure is saved at: {teams_fig_file_path}"+"\n"+"-"*30+"\n")
...
plt.figure(figsize=(8,6))
sns.regplot(data=df_teams,x="avg_age",y="total_market",color="blue",line_kws={"color":"red"})
plt.title("Average age vs. total market value (with regression line)")
plt.xlabel("Average age")
plt.ylabel("Total market value")
plt.grid(True)
teams_fig_file_path=os.path.join(save_figure_teams_dir,"Average age vs. total market value (with regression line).jpg")
plt.savefig(teams_fig_file_path,format="jpg")
plt.close()
print(f"Figure is saved at: {teams_fig_file_path}"+"\n"+"-"*30+"\n")
...
plt.figure(figsize=(8,6))
sns.regplot(data=df_teams,x="foreigners_num",y="total_market",color="blue",line_kws={"color":"red"})
plt.title("Foreigners number vs. total market value (with regression line)")
plt.xlabel("Foreigners number")
plt.ylabel("Total market value")
plt.grid(True)
teams_fig_file_path=os.path.join(save_figure_teams_dir,"Foreigners number vs. total market value (with regression line).jpg")
plt.savefig(teams_fig_file_path,format="jpg")
plt.close()
print(f"Figure is saved at: {teams_fig_file_path}"+"\n"+"-"*30+"\n")
...
plt.figure(figsize=(8,6))
sns.regplot(data=df_teams,x="squad_size",y="avg_market",color="blue",line_kws={"color":"red"})
plt.title("Squad size vs. average market value (with regression line)")
plt.xlabel("Squad size")
plt.ylabel("Average market value")
plt.grid(True)
teams_fig_file_path=os.path.join(save_figure_teams_dir,"Squad size vs. average market value (with regression line).jpg")
plt.savefig(teams_fig_file_path,format="jpg")
plt.close()
print(f"Figure is saved at: {teams_fig_file_path}"+"\n"+"-"*30+"\n")
...
plt.figure(figsize=(8,6))
sns.regplot(data=df_teams,x="avg_age",y="avg_market",color="blue",line_kws={"color":"red"})
plt.title("Average age vs. average market value (with regression line)")
plt.xlabel("Average age")
plt.ylabel("Average market value")
plt.grid(True)
teams_fig_file_path=os.path.join(save_figure_teams_dir,"Average age vs. average market value (with regression line).jpg")
plt.savefig(teams_fig_file_path,format="jpg")
plt.close()
print(f"Figure is saved at: {teams_fig_file_path}"+"\n"+"-"*30+"\n")
...
plt.figure(figsize=(8,6))
sns.regplot(data=df_teams,x="foreigners_num",y="avg_market",color="blue",line_kws={"color":"red"})
plt.title("Foreigners number vs. average market value (with regression line)")
plt.xlabel("Foreigners number")
plt.ylabel("Average market value")
plt.grid(True)
teams_fig_file_path=os.path.join(save_figure_teams_dir,"Foreigners number vs. average market value (with regression line).jpg")
plt.savefig(teams_fig_file_path,format="jpg")
plt.close()
print(f"Figure is saved at: {teams_fig_file_path}"+"\n"+"-"*30+"\n")
